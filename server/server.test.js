...
const server = require('C:\\Users\\15088\\OneDrive\\Desktop\\vsCode\\cosi-103a\\server\\server.js');
...
describe('Test the root path', () => {
  ...
  test('It should return 400 for invalid recipe format', async () => {
    ...
    const response = await request(server).post('/api/recipes').send(invalidRecipe);
